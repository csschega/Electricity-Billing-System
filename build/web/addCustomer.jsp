    ...
    <body>
        ...
        <%
            ...
            if (request.getMethod().compareToIgnoreCase("post") == 0) {
                try {
                    ...
                    String query = "INSERT INTO customer(fname,uname,email,pnumber,address,password,billno) VALUES (?,?,?,?,?,?,?)";
        ...
        <form id="form" method="post" action="addCustomer.jsp" class="form-horizontal">
            ...
            <div class="form-group">
                <div  class="col-sm-4"></div>
                <div  class="col-sm-4 mx-auto">
                    <label style="color:cyan">Bill_No</label>
                    <input type="text" name="ebill" class="form-control" id="password">
                </div>
            </div>
