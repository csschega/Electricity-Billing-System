...
<td><a class="btn btn-success" href="editCustomer.jsp?id=<%=rs.getString("uname") %>" role="button">Edit</a><a class="btn btn-danger" href="removeCustomer.jsp?id=<%=rs.getString("uname") %>" role="button">Remove</a></td>
</tr>
<% }%>
  </tbody>
</table>
